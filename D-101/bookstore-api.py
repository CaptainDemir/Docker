...
app.config['MYSQL_DATABASE_USER'] = 'Demirstore'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Demir_1'
...
# Write a function named `home` which returns 'Welcome to the Captain Demir's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Captain Demir's Bookstore API Service"
